    ...
    try:
       ...
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="I am Recoded By [NOBODY BOTz]",
                    
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("Developer", url=f"https://github.com/NOBODYBOTz")
                            ]
                        ]
                    ),
...
async def list(l, m):
    ...
    ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/Mangerofakott_bot'>🍁Jᴀʀᴠɪs</a>"""
